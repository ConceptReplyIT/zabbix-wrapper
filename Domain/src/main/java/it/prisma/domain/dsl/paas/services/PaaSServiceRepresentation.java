...
@JsonPropertyOrder({ "paasServiceId", "userId", "workgroupId", "name", "description", "domainName", "securityGroup",
		"iaaSFlavor", "loadBalancingInstances", "secureConnectionEnabled", "certificatePath", "qos",
		"publicVisibility", "availabilityZone", "notificationEmail", "createdAt", "status", "operation",
		"errorDescription", "events", "endpoints" })
public class PaaSServiceRepresentation implements GenericPaaSServiceRepresentation {

	public enum PaaSServiceType {

		DBaaS("DBaaS"), BIaaS("BIaaS"), VMaaS("VMaaS"), APPaaS("APPaaS"), APPaaSEnvironment("APPaaSEnvironment"), MQaaS(
				"QueueaaS"), BPMaaS("BPMaaS"), ODaaS("ODaaS");
		String name;
	...
	@JsonProperty("events")
	protected Set<PaaSServiceEventRepresentation> paaSServiceEvents = new HashSet<PaaSServiceEventRepresentation>(0);
	...
	public void setPaasServiceEndpoints(List<PaaSServiceEndpointRepresentation> paasServiceEndpoints) {
	...
	public void setPaaSServiceEvents(Set<PaaSServiceEventRepresentation> paaSServiceEvents) {
	...
	public void setProductSpecificParameters(ProductSpecificParameters productSpecificParameters) {
	 ...
	 */
	public GenericPaaSServiceRepresentation populateSubclass(GenericPaaSServiceRepresentation obj) {
