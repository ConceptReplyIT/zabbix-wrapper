...
@JsonPropertyOrder({ "userAccountId", "firstName", "middleName", "lastName", "employer", "emailRef", "personalPhone",
		"workPhone", "nationality", "taxcode", "avatarUri", "createdAt", "modifiedAt" })
public class UserProfileRepresentation implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1603884351815472936L;
