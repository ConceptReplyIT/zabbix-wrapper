...
public class SignUpUserRequest {
	...
	@JsonProperty("selectedWorkgroups")
	private List<String> selectedWorkgroups;
	...
	@JsonProperty("selectedWorkgroups")
	public List<String> getSelectedWorkgroups() {
		return selectedWorkgroups;
	}

	@JsonProperty("selectedWorkgroups")
	public void setSelectedWorkgroups(List<String> selectedWorkgroups) {
