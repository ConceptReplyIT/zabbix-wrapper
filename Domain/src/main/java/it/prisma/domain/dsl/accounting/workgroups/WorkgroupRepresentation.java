...
@JsonPropertyOrder({ "workgroupId", "label", "description", "approved",
		...
		"applicantsNumber", "approvedMembersNumber", "totalMembersNumber",
		"organization", "iaasTenant" })
public class WorkgroupRepresentation implements java.io.Serializable {

	private static final long serialVersionUID = -7698734981654431150L;
	...
	private Collection<IaaSTenantRepresentation> iaasTenants;
	 ...
	 */
	@JsonProperty("iaasTenant")
	public Collection<IaaSTenantRepresentation> getiaasTenants() {
		return iaasTenants;
	}
	 ...
	 */
	@JsonProperty("iaasTenant")
	public void setiaasTenants(Collection<IaaSTenantRepresentation> iaasTenants) {
	...
	public static WorkgroupRepresentation findWorkgroup(Collection<WorkgroupRepresentation> workgroups, long id) {
		for(WorkgroupRepresentation workgroup:workgroups)
			if(workgroup.getWorkgroupId()==id)
				return workgroup;
		return null;
	}
