...
public class OpenstackTenantListResponse {
	...
	private List<IaaSTenantRepresentation> tenants = new ArrayList<IaaSTenantRepresentation>();
	...
	@JsonProperty("tenants")
	public List<IaaSTenantRepresentation> getTenants() {
		return tenants;
	}

	@JsonProperty("tenants")
	public void setTenants(List<IaaSTenantRepresentation> tenants) {
