...
public class GroupsMachine {
    ...
    /**
     * 
     * @return The infrastructureGroupName
     */
    @JsonProperty("infrastructureGroupName")
    ...
    @Override
    public int hashCode() {
	return new HashCodeBuilder().append(infrastructureGroupName).append(infrastructureMachine).toHashCode();
    }
