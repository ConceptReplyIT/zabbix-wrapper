...
public class ZabbixAPIClient extends AbstractAPIClient {
	 ...
	 * CREATE PROXY
	 ***************/
	public ZabbixUpdateProxyResponse createProxyClient(JSONRPCRequest<ZabbixParamCreateProxyRequest> request)
			throws ZabbixClientException {
	...
	public ArrayList<ZabbixItemResponse> getItemsClient(JSONRPCRequest<ZabbixParamItemRequest> request)
		...
		try {
			...
			result = restClient.postRequest(baseWSUrl, headers, ge, RestClientHelper.JsonEntityBuilder.MEDIA_TYPE,
					new ZabbixResponseDecoder<ArrayList<ZabbixItemResponse>>(ArrayList.class, ZabbixItemResponse.class),
					null);
			return handleResult(result);
	 ...
	 * DELETE PROXY
	 **************/
	public ZabbixUpdateProxyResponse deleteProxyClient(JsonRpcDeleteHostRequest request) throws ZabbixClientException {
		...
		try {
			...
			result = restClient.postRequest(baseWSUrl, headers, ge, RestClientHelper.JsonEntityBuilder.MEDIA_TYPE,
					new ZabbixResponseDecoder<ArrayList<ZabbixTemplateResponseV2_4>>(ArrayList.class,
							ZabbixTemplateResponseV2_4.class),
					null);
			return handleResult(result);
	...
	public ZabbixCreateUserResponse createUserClient(JSONRPCRequest<ZabbixCreateUserRequest> requestUser)
			throws ZabbixClientException {
		...
		try {
			...
			result = restClient.postRequest(baseWSUrl, headers, ge, RestClientHelper.JsonEntityBuilder.MEDIA_TYPE,
					new ZabbixResponseDecoder<ZabbixCreateUserResponse>(ZabbixCreateUserResponse.class), null);
			return handleResult(result);
		} catch (IOException | RestClientException | NoMappingModelFoundException | MappingException
				| ServerErrorResponseException e) {
			throw new ZabbixClientException(e);
	 ...
	 * @return List<ZabbixGetUserResponse>
	 * @throws ZabbixClientException
	 */
	...
	public List<ZabbixGetActionResponse> getActionClient(JSONRPCRequest<ZabbixGetActionRequest> requestUser)
			throws ZabbixClientException {
