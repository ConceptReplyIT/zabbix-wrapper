...
public class MetricsParserHelper {
    ...
    // used
    public static Float getMetricParsedValue(String metricValueType, String metricValue) throws NumberFormatException {
	...
	if (metricValueType.equals("0")) {
	    ...
	    return Float.parseFloat(metricValue);
	} else if (metricValueType.equals("4") || metricValueType.equals("1") || metricValueType.equals("2")) {
