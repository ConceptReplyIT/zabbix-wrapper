...
public class WrapperProviderZabbix<T> implements WrapperProvider<T>, Serializable {
	...
	public T getWrapperIaaSPaaS(String adapterType, String zone, String serverType, String group, String host)
		...
		return (T) determineAdapt.getAdapter(adapterType).getInfoWrapperGeneric(zone, serverType, group, host, null,
	...
	public T getWrapperHostComb(String adapterType, String zone, String serverType, String group, String host,
		...
		if ((thresholds == null || !thresholds) && serviceId == null && metrics == null) {
			return (T) determineAdapt.getAdapter(adapterType).getHostsInfoWrapped(zone, serverType, group);
			...
			return (T) determineAdapt.getAdapter(adapterType).getMetricsByHost(zone, serverType, group, host);
			...
			if (serverType.equalsIgnoreCase(InfoType.INFRASTRUCTURE.getInfoType())
				...
				// resource
				return (T) determineAdapt.getAdapter(adapterType).getInfoWrapperGeneric(zone, serverType, group, null,
						null, serviceId, null, null, null, null, null);
		} else {
