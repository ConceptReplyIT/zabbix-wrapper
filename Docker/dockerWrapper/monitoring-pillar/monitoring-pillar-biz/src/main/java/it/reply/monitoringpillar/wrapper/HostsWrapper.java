...
public class HostsWrapper implements Serializable {
	 ...
	 */
	public MonitoringWrappedResponsePaasGroups4HostList getHostsWrapped(String zone, String serverType,
			String groupName, List<ZabbixHostGroupResponse> groups, List<ZabbixMonitoredHostResponseV2_4> hosts)
					throws ZabbixException {
		...
		for (ZabbixHostGroupResponse workGroup : groups) {
			...
			for (ZabbixMonitoredHostResponseV2_4 host : hosts) {
				...
				group.getPaasMachines().addAll(
						getMachinesList(zone, serverType, hostGroupIdtoAdapter, groupName, hosts, host, paasMachine));
			}
	 ...
	 */
	@SuppressWarnings({ "unchecked", "unused" })
	public List<PaasMachineListWrapped> getMachinesList(String zone, String serverType, String hostGroupIdtoAdapter,
