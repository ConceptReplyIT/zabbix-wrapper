...
public class TemplateIDByName implements Serializable {
	...
	public List<String> getTemplateID(String zone, String serverType, List<String> services, Boolean activeMode)
			throws ZabbixException {

		ArrayList<ZabbixTemplateResponse> templateList = (ArrayList<ZabbixTemplateResponse>) zabAdapMetrics
				.getTemplateService(zone, serverType, ZabbixMethods.TEMPLATE.getzabbixMethod());
