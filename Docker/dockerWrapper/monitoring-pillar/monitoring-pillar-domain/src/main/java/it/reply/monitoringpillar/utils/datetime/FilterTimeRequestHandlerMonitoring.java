...
public class FilterTimeRequestHandlerMonitoring {
	...
	private static final String INCORRECT_DATE = "Incorrect date inserted: DateTo is before than DateFrom";
	...
	public static boolean checkDateFormat(FilterTimeRequest timerequest) throws IllegalArgumentException {
		...
		else if (dayfrom < 01 && dayfrom > 31 || (Integer.parseInt(timerequest.getDateTo().getDay()) < 01
	...
	public static boolean isBeforeThen24h(FilterTimeRequest requestTime) throws IllegalArgumentException {
		...
		if (requestTime.getFrom() != null && requestTime.getTo() != null
			...
			if ((requestTime.getFrom() < aDayPast) || (requestTime.getTo() < aDayPast)
					&& (requestTime.getTo() > aDayPast && requestTime.getTo() < (System.currentTimeMillis() / 1000L)
			...
			if ((requestTime.getDateTo().getUpToNow() != null && requestTime.getDateTo().getUpToNow()
					...
					|| (requestTime.getDateTo().getUpToNow() != null && !(requestTime.getDateTo().getUpToNow())
