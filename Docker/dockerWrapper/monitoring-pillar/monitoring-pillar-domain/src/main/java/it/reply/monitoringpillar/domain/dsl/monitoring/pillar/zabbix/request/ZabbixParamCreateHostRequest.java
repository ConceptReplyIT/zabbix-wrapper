...
@JsonPropertyOrder({ "host", "proxy_hostid", "macros", "interfaces", "groups", "templates", "inventory" })
public class ZabbixParamCreateHostRequest {
	...
	private ArrayList<ZabbixParamInterfaceIntoHostCreateRequest> interfaces = new ArrayList<ZabbixParamInterfaceIntoHostCreateRequest>();
	@JsonProperty("groups")
	private ArrayList<ZabbixParamGroupIntoHostCreateRequest> groups = new ArrayList<ZabbixParamGroupIntoHostCreateRequest>();
