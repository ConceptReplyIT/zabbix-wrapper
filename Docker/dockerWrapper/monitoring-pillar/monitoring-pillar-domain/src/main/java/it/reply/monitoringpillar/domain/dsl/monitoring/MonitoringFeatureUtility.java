...
public class MonitoringFeatureUtility {
	...
	public enum MonitoringMetricsPAASNames {
		...
		Ceilometer_CPU_LOAD("IaaSCeilometerCPULOAD"), Ceilometer_CPU_Uptime("IaaSCeilometerUPTIME"), Ceilometer_STORAGE(
				"IaaSCeilometerDISKROOTSIZE"), Ceilometer_NETW_OUT("IaaSCeilometerNETWORKOUT"), Ceilometer_NETW_IN(
						"IaaSCeilometerNETWORKIN"), Ceilometer_RAM("IaaSCeilometerMEMORYRAM"), Ceilometer_VCPUs(
								"IaaSCeilometerVCPUS"), Ceilometer_Disk_Ephemeral(
										"IaaSCeilometerDISKEPHEMERALSIZE"), Ceilometer_Storage("IaaSCeilometerSTORAGE"),

		// Watcher Metrics
										MySQLQueriesPerSecond("MySQLQueriesPerSecond"), MySQLSelectPerSecond(
