...
public interface MonitoringPillarWS {
	...
	public Response listAllZones(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@PathParam("adapterType") String adapterType)
	...
	public Response listAllServerType(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@PathParam("adapterType") String adapterType, @PathParam("zone") String zone)
					throws IllegalArgumentMonitoringException, NotFoundMonitoringException;
	...
	public Response getGroupList(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@DefaultValue("zabbix") @PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type) throws MonitoringException;
	...
	public Response getGroupInfo(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@DefaultValue("zabbix") @PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type, @PathParam("group") String group) throws MonitoringException;
	...
	public Response createGroup(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@DefaultValue("zabbix") @PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type, HostGroupMonitoringCreateRequest group) throws MonitoringException;
	...
	public Response updateGroup(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type, @PathParam("group") String group, UpdateGroupName newGroupName)
	...
	public Response createProxy(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type, @PathParam("group") String group, ProxyCreationRequest proxy)
					throws MonitoringException;
	...
	public Response deleteProxy(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type, @PathParam("group") String group, @PathParam("proxy") String proxy)
					throws MonitoringException;
	...
	public Response getHost(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type, @PathParam("group") String group,
	...
	public Response createHost(@Context HttpServletRequest request, @Context HttpServletResponse response,
			...
			HostMonitoringRequest hostMonitoringRequest) throws NameNotFoundException, MonitoringException;
	...
	public Response getFilteredEventsByTimestamp(@Context HttpServletRequest request,
			...
			@PathParam("host") String host, @QueryParam("from") Long from, @QueryParam("to") Long to)
					throws MonitoringException;
	 ...
	 ****************************/
	@Path("/{adapterType}/zones/{zone}/types/{type}/groups/{group}/hosts/{host}/metrics/{metric}/history")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	 ...
	 * are to be specified in the request.
	 */
	@Path("/{adapterType}/zones/{zone}/types/{type}/groups/{group}/hosts/{host}/metrics/{metric}/filtered-history")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response getHistoryByTime(@Context HttpServletRequest request, @Context HttpServletResponse response,
	 ...
	 * are to be specified in the request.
	 */
	@Path("/{adapterType}/zones/{zone}/types/{type}/groups/{group}/services/{service}/metrics/{metric}/history")
	@POST
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	...
	public Response getEventCallback(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type, EventCallbackRequest eventCallback) throws MonitoringException;
	...
	public Response getSendMail(@Context HttpServletRequest request, @Context HttpServletResponse response,
			@PathParam("adapterType") String adapterType, @PathParam("zone") String zone,
			@PathParam("type") String type, SendMailRequest sendMailRequest) throws MonitoringException;
