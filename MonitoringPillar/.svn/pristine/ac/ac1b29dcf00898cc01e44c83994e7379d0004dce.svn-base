...
public interface MonitoringPillarWS {
	...
	// TODO: se un endpoint non supporta alcuni gruppi come lo gestiamo?

	/******************************
	 * GET IaaS/PaaS Info by Groups
	 ******************************/
	@GET
	@Path("/{adapterType}/types/{type}/groups/")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	 ...
	 ******************************/
	@GET
	@Path("/{adapterType}/types/{type}/groups/{group}")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	 ...
	 ******************************************************/
	@GET
	@Path("/{adapterType}/types/{type}/groups/{group}/hosts")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	 ...
	 **********************************************************/
	@Path("/{adapterType}/types/{type}/groups/{group}/hosts/{host}/thresholds")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	 ...
	 * They can be filtered by period of time as much as the history
	 */
	@Path("/{adapterType}/types/{type}/groups/{group}/hosts/{host}/events")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	 ...
	 */
	@Path("/{adapterType}/types/{type}/groups/{group}/hosts/{host}/metrics/{metric}")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	 ...
	 ****************************/
	@Path("/{adapterType}/types/{type}/groups/{group}/hosts/{host}/metrics/{metric}/history")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	 ...
	 * are to be specified in the request.
	 */
	@Path("/{adapterType}/types/{type}/groups/{group}/services/{service}/metrics/{metric}/history")
	@POST
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response getHistoryByServiceandTime(@DefaultValue("zabbix") @PathParam("adapterType") String adapterType,
			@PathParam("type") String type, @PathParam("group") String group, @PathParam("service") Long service,
			@PathParam("metric") String metric, FilterTimeRequest requestTime) throws MonitoringException;
