...
public class ZabbixConstant {
	...
	public static final String WRONGHOSTNAME = "Wrong Host Name Inserted: Not Existing Into Platform";
	public static final String WRONGGROUPNAME = "Wrong Group Name Inserted, Not Existing Into Platform: ";
	public static final String INVENTORY_NOT_SET = "Inventory out of START_ARRAY token";
