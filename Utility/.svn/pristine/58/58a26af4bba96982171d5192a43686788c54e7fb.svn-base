...
public class RestClientImpl<T extends BaseRestResponseResult> extends AbstractRestClient<T> {
	...
	public T getRequest(String URL, MultivaluedMap<String, Object> headers,
			it.prisma.utils.web.ws.rest.restclient.RestClient.RequestOptions reqOptions, RestResponseDecoder<T> rrd,
	...
	public RestMessage getRequest(String URL, MultivaluedMap<String, Object> headers,
			it.prisma.utils.web.ws.rest.restclient.RestClient.RequestOptions reqOptions) throws RestClientException {
	...
	public <E> T postRequest(String URL, MultivaluedMap<String, Object> headers, GenericEntity<E> body,
			MediaType bodyMediaType, it.prisma.utils.web.ws.rest.restclient.RestClient.RequestOptions reqOptions,
	...
	@Override
	public <E> T doRequest(it.prisma.utils.web.ws.rest.restclient.RestClient.RestMethod method, String URL,
	...
	@Override
	public <E> RestMessage doRequest(it.prisma.utils.web.ws.rest.restclient.RestClient.RestMethod method, String URL,
			MultivaluedMap<String, Object> headers, MultivaluedMap<String, Object> queryParams, GenericEntity<E> body,
			MediaType bodyMediaType, it.prisma.utils.web.ws.rest.restclient.RestClient.RequestOptions reqOptions,
